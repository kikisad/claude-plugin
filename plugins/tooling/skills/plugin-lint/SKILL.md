...
Références :
- Bonnes pratiques officielles : [references/best-practices.md](${CLAUDE_SKILL_DIR}/references/best-practices.md)
...
## 2. Exécuter les checklists

Consulter `references/best-practices.md` pour la checklist complète.
